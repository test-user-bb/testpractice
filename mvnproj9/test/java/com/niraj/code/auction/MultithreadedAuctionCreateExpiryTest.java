...
public class MultithreadedAuctionCreateExpiryTest {
	...
	public void auctionCreateTest() {
		...
		auctionManager.receiveNewAuctionfromUser(user1, item2, 200.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user1, item3, 300.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user1, item4, 400.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user1, item5, 400.0,new Date(), new Date());
		...
		auctionManager.receiveNewAuctionfromUser(user2, item6, 100.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user2, item7, 200.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user2, item8, 300.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user2, item9, 400.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user2, item10, 400.0,new Date(), new Date());
		...
		auctionManager.receiveNewAuctionfromUser(user3, item11, 100.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user3, item12, 200.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user3, item13, 300.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user3, item14, 400.0,new Date(), new Date());
		auctionManager.receiveNewAuctionfromUser(user3, item15, 400.0,new Date(), new Date());
		...
		log.info(String.format("Display all the auction: \n %s",auctionManager.getAllAuctions()) ) ;
		log.info(String.format("Total Number of auctions got created: %d",auctionManager.getAllAuctionsCount()));
		
		assertEquals(15, auctionManager.getAllAuctionsCount());
		
		log.info(String.format("Display top bids for the item: \n %s",auctionManager.getTopNBids(item1.getItemId())));
		log.info(String.format("Display top bids for the item: \n %s",auctionManager.getTopNBids(item10.getItemId())));
		log.info(String.format("Display top bids for the item: \n %s",auctionManager.getTopNBids(item15.getItemId())));
		...
		log.info(String.format("Display all the auction: \n %s",auctionManager.getAllAuctions()) ) ;
		log.info(String.format("Total Number of auctions remaining after expiry: %d",auctionManager.getAllAuctionsCount()));
		
		//The Actual Test
		assertEquals(0, auctionManager.getAllAuctionsCount());
