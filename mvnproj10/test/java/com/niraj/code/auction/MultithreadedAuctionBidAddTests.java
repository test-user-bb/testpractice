...
import com.niraj.code.utils.Utilities;
...
public class MultithreadedAuctionBidAddTests {
	...
	public void bidAdditionTest() {
		...
		auctionManager.receiveNewAuctionfromUser(user1, item1, 100.0,new Date(), Utilities.getFutureDateAfterSeconds(60));
		auctionManager.receiveNewAuctionfromUser(user1, item2, 100.0,new Date(), Utilities.getFutureDateAfterSeconds(60));
		
		Utilities.sleepForMS(1000);
